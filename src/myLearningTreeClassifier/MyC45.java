...
/**
 * Implementation of c45 Algorithm in Machine Learning.
 * @author cmrudi
 */
...
public class MyC45 extends Classifier {
    ...
    public Capabilities getCapabilities(){
        ...
        myCapabilities.setMinimumNumberInstances(0);
   ...
   */
    ...
    private double getTrainingErrors(){
    	...
    	errors = errors+myChilds[i].getTrainingErrors();
          return errors;
        }
      }
    ...
    protected void prune(MyC45 myC45) {
    	boolean prunable = false;
    	int idxOfLargestBranch;
    	
    	for (MyC45 child : this.myChilds) {
    		if (child.isLeaf) {
    			prunable = true;
    		}
    	}
    	...
    	idxOfLargestBranch = (int) localModel().distribution().numIncorrect();
